...
const PROJECTS = [
  {
    ...
    sub:      'A refined residential address in the heart of Wakad. Thoughtfully designed homes that balance modern living with natural calm.',
    stats: [
      { num: '24',   label: 'Floors'     },
      { num: '120',  label: 'Units'      },
    ...
    infoBody: 'PK Canopus rises 24 floors above Wakad with 120 meticulously crafted residences. Every unit is oriented to maximise light, air, and views — because a home should feel as good as it looks. From the double-height lobby to the sky-level amenity deck, every touchpoint has been considered.',
    amenities: [
    ...
    gallery: [
      { src: '/carousel-canopus/building.jpg',     caption: 'Exterior'        },
      { src: '/carousel-canopus/pool-day.jpg',     caption: 'Aqua'            },
      { src: '/carousel-canopus/building-2.jpg',   caption: 'Elevation'       },
      { src: '/carousel-canopus/gym.jpg',          caption: 'Fitness Studio'  },
      { src: '/carousel-canopus/clubhouse.jpg',    caption: 'Clubhouse'       },
      { src: '/carousel-canopus/theatre.jpg',      caption: 'Private Theatre' },
      { src: '/carousel-canopus/tennis-court.jpg', caption: 'Sport Court'     },
    ],
    video: {
      ytId:    'hGmHAxVMwiQ',
      thumb:   '/carousel-canopus/building-2.jpg',
  ...
  },
  {
    ...
    location: 'Baner · Pune',
    year:     '2027',
    sub:      'Where restrained luxury meets architectural precision. PK Ornate redefines what a Pune address can feel like — unhurried, considered, and built to last.',
    stats: [
      { num: '32',   label: 'Floors'     },
      { num: '96',   label: 'Units'      },
      { num: '4.1L', label: 'Sq. Ft.'   },
      { num: '2027', label: 'Completion' },
    ],
    infoHeading: ['Crafted for', 'those who know.'],
    infoBody: 'PK Ornate stands 32 floors over Baner with 96 residences designed for those who value quietude as much as quality. Wider floor plates, double-height entries, and a curated amenity programme — each element chosen not for spectacle, but for the life it enables.',
    amenities: [
      ...
      'Concierge services',
      'Sky garden on every 8th floor',
      'EV charging bays',
      '4-tier security & biometric access',
    ],
    heroBg: '/carousel-ornate/hero.png',
    gallery: [
      { src: '/carousel-ornate/PK Ornate Brochure (1).pdf (2).png',  caption: 'Overview'    },
      { src: '/carousel-ornate/PK Ornate Brochure (1).pdf (6).png',  caption: 'Design'      },
      { src: '/carousel-ornate/PK Ornate Brochure (1).pdf (7).png',  caption: 'Elevation'   },
      { src: '/carousel-ornate/PK Ornate Brochure (1).pdf (8).png',  caption: 'Perspective' },
    ],
    video: {
      ytId:    '',
      thumb:   '/carousel-ornate/PK Ornate Brochure (1).pdf (2).png',
      tagline: 'A new chapter begins.',
      lines: [
        { text: 'Not every building',  indent: 0, italic: false },
        { text: 'becomes a landmark.', indent: 1, italic: false },
        { text: 'This one will.',      indent: 2, italic: true  },
      ],
      cardMeta: { label: 'PK Ornate — Baner, Pune', year: '2027' },
    },
  },
]
