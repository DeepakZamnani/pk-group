  ...
  },
{
  ...
  location:    'Pune',
  type:        'Full-time',
  description: 'Oversee financial operations, manage budgeting and reporting processes, and ensure compliance with accounting standards while supporting the financial growth and stability of PK Group projects.',
  requirements: [
    'Bachelor’s degree in Accounting, Finance, or related field',
    'Proficiency in Tally, Excel, and financial reporting tools',
    'Strong knowledge of taxation, compliance, and budgeting processes',
  ],
},
{
  id:          'sales-executive-manager',
  department:  'Sales',
  title:       'Sales Executive Manager',
  location:    'Pune',
  type:        'Full-time',
  description: 'Lead and manage the sales team, develop strong relationships with channel partners and clients, and drive residential sales growth while ensuring achievement of revenue targets for PK Group projects.',
  requirements: [
    'Any graduate with excellent leadership and communication skills',
    'Strong network with brokers, channel partners, and direct buyers in Pune',
    'Proven ability to achieve sales targets and manage high-performing teams',
  ],
},
  {
    id:          'project-manager',
